...
function FixBoxes.FixAll()
    ...
    FixBoxes.Finally("st03_0402_sm42_476_ES_BreakBox12_gimmick") -- Substation Street Breakable Box (Downtown)
    FixBoxes.Finally("st03_0611_sm42_476_ES_BreakBox16_gimmick") -- Substation Street Breakable Box (Downtown)
